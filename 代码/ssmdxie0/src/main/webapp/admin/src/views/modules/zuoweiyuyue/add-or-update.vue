<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="自修室名称" prop="zixiushimingcheng">
          <el-input v-model="ruleForm.zixiushimingcheng" 
              placeholder="自修室名称" clearable  :readonly="ro.zixiushimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="自修室名称" prop="zixiushimingcheng">
              <el-input v-model="ruleForm.zixiushimingcheng" 
                placeholder="自修室名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
